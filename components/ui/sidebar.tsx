...
function SidebarProvider({
  ...
  const hydrated = useMediaQuery("(min-width: 0px)");
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "w-[calc(var(--sidebar-width-icon)+(--spacing(4)))] xl:w-(--sidebar-width)",
      ...
      <div
        ...
        className={cn(
          ...
          "xl:p-[unset] xl:group-data-[side=left]:border-r xl:group-data-[side=right]:border-l",

          !hydrated &&
            "w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)] xl:w-(--sidebar-width)!",
      ...
      >
        <div
          ...
          className={cn(
            ...
            "max-xl:border-sidebar-border max-xl:rounded-lg max-xl:border max-xl:shadow-sm"
          )}
        >
          {children}
        </div>
